package org.opengroup.osdu.crs.convert.trajectory;
...
import org.opengroup.osdu.crs.converter.AzimuthCorrector;
import org.opengroup.osdu.crs.converter.TrajectoryConverter;
...
public class ConvertTrajectoryTests {
    ...
    public void convertTrajectoryWithSuccessfulResponseLMP() {
        ...
        lenient().when(trajectoryConverter.computeScaleFactorAndConvergence(Mockito.any(DpsHeaders.class), Mockito.any(ConvertTrajectoryRequestV4.class), Mockito.anyBoolean(), Mockito.any())).thenReturn(new ArrayList<ScaleConvergence>());
