...
from swagger_client.models.convert_points_response import ConvertPointsResponse


class TestConvertPointsResponse(unittest.TestCase):
    """ ConvertPointsResponse unit test stubs """
    ...
    def testConvertPointsResponse(self):
        """
        Test ConvertPointsResponse
        """
        model = swagger_client.models.convert_points_response.ConvertPointsResponse()
