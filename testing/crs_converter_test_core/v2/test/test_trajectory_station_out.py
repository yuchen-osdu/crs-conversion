...
from swagger_client.models.trajectory_station_out import TrajectoryStationOut


class TestTrajectoryStationOut(unittest.TestCase):
    """ TrajectoryStationOut unit test stubs """
    ...
    def testTrajectoryStationOut(self):
        """
        Test TrajectoryStationOut
        """
        model = swagger_client.models.trajectory_station_out.TrajectoryStationOut()
