...
from swagger_client.models.any_crs_geo_json_polygon import AnyCrsGeoJsonPolygon


class TestAnyCrsGeoJsonPolygon(unittest.TestCase):
    """ AnyCrsGeoJsonPolygon unit test stubs """
    ...
    def testAnyCrsGeoJsonPolygon(self):
        """
        Test AnyCrsGeoJsonPolygon
        """
        model = swagger_client.models.any_crs_geo_json_polygon.AnyCrsGeoJsonPolygon()
