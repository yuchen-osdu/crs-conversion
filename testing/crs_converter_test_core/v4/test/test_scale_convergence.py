...
from swagger_client.models.scale_convergence import ScaleConvergence


class TestScaleConvergence(unittest.TestCase):
    """ ScaleConvergence unit test stubs """
    ...
    def testScaleConvergence(self):
        """
        Test ScaleConvergence
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.scale_convergence.ScaleConvergence()
        pass
