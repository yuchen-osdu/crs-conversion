...
from swagger_client.apis.crsconverterapiv4_api import Crsconverterapiv4Api


class TestCrsconverterapiv4Api(unittest.TestCase):
    """ Crsconverterapiv4Api unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.crsconverterapiv4_api.Crsconverterapiv4Api()
