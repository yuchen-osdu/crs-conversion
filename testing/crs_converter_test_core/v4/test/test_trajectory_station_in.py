...
from swagger_client.models.trajectory_station_in import TrajectoryStationIn


class TestTrajectoryStationIn(unittest.TestCase):
    """ TrajectoryStationIn unit test stubs """
    ...
    def testTrajectoryStationIn(self):
        """
        Test TrajectoryStationIn
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.trajectory_station_in.TrajectoryStationIn()
        pass
