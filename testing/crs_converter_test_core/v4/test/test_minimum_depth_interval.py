...
from swagger_client.models.minimum_depth_interval import MinimumDepthInterval


class TestMinimumDepthInterval(unittest.TestCase):
    """ MinimumDepthInterval unit test stubs """
    ...
    def testMinimumDepthInterval(self):
        """
        Test MinimumDepthInterval
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.minimum_depth_interval.MinimumDepthInterval()
        pass
