...
class CRSConversionApi(object):
    ...
    def convert_bin_grid(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.convert_bin_grid(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ConvertBinGridRequest body:
        ...
        if kwargs.get('callback'):
            return self.convert_bin_grid_with_http_info(**kwargs)
        else:
            (data) = self.convert_bin_grid_with_http_info(**kwargs)
            return data

    def convert_bin_grid_with_http_info(self, **kwargs):
        """
        CRS Convert service is an OSDU platform standard method for QC and conversion of Bin Grids, associated in particular with ingested seismic volumes, that describe the “real world” (Easting, Northing) of bin grid centers at (inline, crossline) local coordinates
        QC check of the “squareness” of a Bin Grid defined using 4 corner points. Coordinate conversion of a Bin Grid to a new CRS and “square it up” (if target CRS is same as original CRS then conversion is omitted, and the squareness test is done in the original CRS). Calculate derived P6 parameters from the input 4 corners. Calculate WGS 84 coordinates at the corners. Returns converted Bin Grid and a QC of squareness of the bin grid
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.convert_bin_grid_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method convert_bin_grid" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/v3/convertBinGrid', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ConvertBinGridResponse',
    ...
    def convert_geo_json_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/v3/convertGeoJson', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def convert_point_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/v3/convert', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
