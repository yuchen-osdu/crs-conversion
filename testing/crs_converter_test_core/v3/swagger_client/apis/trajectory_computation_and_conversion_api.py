...
class TrajectoryComputationAndConversionApi(object):
    """
    ...
    def convert_trajectory(self, **kwargs):
        ...
        :param ConvertTrajectoryRequest body:
        :param str data_partition_id:
        :return: ConvertTrajectoryResponse
    ...
    def convert_trajectory_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/v3/convertTrajectory', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ConvertTrajectoryResponse',
