...
from swagger_client.models.max_mis_location import MaxMisLocation


class TestMaxMisLocation(unittest.TestCase):
    """ MaxMisLocation unit test stubs """
    ...
    def testMaxMisLocation(self):
        """
        Test MaxMisLocation
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.max_mis_location.MaxMisLocation()
        pass
