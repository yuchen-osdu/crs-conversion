...
from swagger_client.models.abstract_bin_grid import AbstractBinGrid


class TestAbstractBinGrid(unittest.TestCase):
    """ AbstractBinGrid unit test stubs """
    ...
    def testAbstractBinGrid(self):
        """
        Test AbstractBinGrid
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.abstract_bin_grid.AbstractBinGrid()
        pass
