...
from swagger_client.models.convert_geo_json_request import ConvertGeoJsonRequest


class TestConvertGeoJsonRequest(unittest.TestCase):
    """ ConvertGeoJsonRequest unit test stubs """
    ...
    def testConvertGeoJsonRequest(self):
        """
        Test ConvertGeoJsonRequest
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.convert_geo_json_request.ConvertGeoJsonRequest()
        pass
