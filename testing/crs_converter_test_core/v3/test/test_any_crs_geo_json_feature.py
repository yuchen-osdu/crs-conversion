...
from swagger_client.models.any_crs_geo_json_feature import AnyCrsGeoJsonFeature


class TestAnyCrsGeoJsonFeature(unittest.TestCase):
    """ AnyCrsGeoJsonFeature unit test stubs """
    ...
    def testAnyCrsGeoJsonFeature(self):
        """
        Test AnyCrsGeoJsonFeature
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.any_crs_geo_json_feature.AnyCrsGeoJsonFeature()
        pass
