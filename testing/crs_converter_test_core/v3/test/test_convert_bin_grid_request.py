...
from swagger_client.models.convert_bin_grid_request import ConvertBinGridRequest


class TestConvertBinGridRequest(unittest.TestCase):
    """ ConvertBinGridRequest unit test stubs """
    ...
    def testConvertBinGridRequest(self):
        """
        Test ConvertBinGridRequest
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.convert_bin_grid_request.ConvertBinGridRequest()
        pass
