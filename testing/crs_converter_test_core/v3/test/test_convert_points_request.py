...
from swagger_client.models.convert_points_request import ConvertPointsRequest


class TestConvertPointsRequest(unittest.TestCase):
    """ ConvertPointsRequest unit test stubs """
    ...
    def testConvertPointsRequest(self):
        """
        Test ConvertPointsRequest
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.convert_points_request.ConvertPointsRequest()
        pass
