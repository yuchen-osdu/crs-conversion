...
from swagger_client.apis.crs_point_conversion_api import CRSPointConversionApi


class TestCRSPointConversionApi(unittest.TestCase):
    """ CRSPointConversionApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.crs_point_conversion_api.CRSPointConversionApi()
