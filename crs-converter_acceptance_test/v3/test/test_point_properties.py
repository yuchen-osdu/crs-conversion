...
class TestPointProperties(unittest.TestCase):
    """ PointProperties unit test stubs """
    ...
    def testPointProperties(self):
        """
        Test PointProperties
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.point_properties.PointProperties()
        pass
