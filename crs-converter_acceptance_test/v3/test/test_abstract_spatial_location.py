...
from swagger_client.models.abstract_spatial_location import AbstractSpatialLocation


class TestAbstractSpatialLocation(unittest.TestCase):
    """ AbstractSpatialLocation unit test stubs """
    ...
    def testAbstractSpatialLocation(self):
        """
        Test AbstractSpatialLocation
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = swagger_client.models.abstract_spatial_location.AbstractSpatialLocation()
        pass
