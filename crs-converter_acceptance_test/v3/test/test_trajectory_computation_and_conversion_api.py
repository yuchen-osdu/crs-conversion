...
from swagger_client.apis.trajectory_computation_and_conversion_api import TrajectoryComputationAndConversionApi


class TestTrajectoryComputationAndConversionApi(unittest.TestCase):
    """ TrajectoryComputationAndConversionApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.trajectory_computation_and_conversion_api.TrajectoryComputationAndConversionApi()
