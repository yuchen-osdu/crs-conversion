...
{{- define "crsConversion.getAutoscaling" -}}
...
{{- define "crsConversion.minReplicasSpot" -}}
{{- $tier := include "crsConversion.getTier" . -}}
...
{{- define "crsConversion.maxReplicasSpot" -}}
{{- $tier := include "crsConversion.getTier" . -}}
...
{{- define "crsConversion.replicasStandard" -}}
{{- $tier := include "crsConversion.getTier" . -}}
